...
@click.option('--lumisection_list', default=False, help='Provides list of lumisection for a given run')
@click.option('--variable_list', default=False, help='Provides list of variables for a given lumisection')
@click.option('--lumi_number', default=0, help='Lumisection number for variable exploration')
@pass_config
